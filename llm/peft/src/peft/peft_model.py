...
from .tuners import LoraModel, BottleneckModel, PrefixEncoder, PromptEmbedding, PromptEncoder, DoraModel, sinLoraModel,sinDoraModel
from .utils import (
    ...
    **Attributes**:
    ...
    def __init__(self, model, peft_config: PeftConfig):
        ...
        if isinstance(self.peft_config, PromptLearningConfig):
            ...
            elif self.peft_config.peft_type == PeftType.SINLORA:
                self.base_model = sinLoraModel(peft_config, model)
            ...
            elif self.peft_config.peft_type == PeftType.SINDORA:
                self.base_model = sinDoraModel(peft_config, model)
    ...
    def from_pretrained(cls, model, model_id, **kwargs):
        ...
        if getattr(model, "hf_device_map", None) is not None:
            ...
            if model.peft_config.peft_type == PeftType.LORA or model.peft_config.peft_type == PeftType.BOTTLENECK or model.peft_config.peft_type == PeftType.DORA or model.peft_config.peft_type == PeftType.SINLORA or model.peft_config.peft_type == PeftType.SINDORA:
