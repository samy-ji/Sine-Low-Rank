    ...
    **Attributes**:
    ...
    def from_pretrained(cls, model, model_id, **kwargs):
        ...
        if getattr(model, "hf_device_map", None) is not None:
            ...
            if model.peft_config.peft_type == PeftType.LORA or model.peft_config.peft_type == PeftType.BOTTLENECK or model.peft_config.peft_type == PeftType.DORA or model.peft_config.peft_type == PeftType.SINLORA:
