...
def main(
    ...
    if args.adapter == "LoRA" or args.adapter == "sinDoRA":
        print("Merge LoRA/sinDoRA weights into the original weights")
...
def parse_args():
    ...
    parser.add_argument('--adapter', choices=['LoRA', 'AdapterP', 'AdapterH', 'Parallel', 'sinDoRA'],
                        required=True)
